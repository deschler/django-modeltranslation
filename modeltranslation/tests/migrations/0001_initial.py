# Generated by Django 5.2.7 on 2026-02-26 11:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(fields=("title",), name="unique_sfield"),
                    models.UniqueConstraint(fields=("title", "sub_title2"), name="unique_mfields"),
                    models.UniqueConstraint(fields=("title", "email"), name="unique_partfield"),
                    models.UniqueConstraint(fields=("title_de",), name="unique_sfield-de"),
                    models.UniqueConstraint(fields=("title_en",), name="unique_sfield-en"),
                    models.UniqueConstraint(
                        fields=("title_de", "sub_title2_de"), name="unique_mfields-de"
                    ),
                    models.UniqueConstraint(
                        fields=("title_en", "sub_title2_en"), name="unique_mfields-en"
                    ),
                    models.UniqueConstraint(
                        fields=("title_de", "email"), name="unique_partfield-de"
                    ),
                    models.UniqueConstraint(
                        fields=("title_en", "email"), name="unique_partfield-en"
                    ),
                ],
                "unique_together": {
                    ("title", "sub_title1"),
                    ("title_de", "sub_title1_de"),
                    ("title_en", "sub_title1_en"),
                },
            },
        ),
        migrations.CreateModel(
