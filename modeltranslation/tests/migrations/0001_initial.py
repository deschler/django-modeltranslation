# Generated by Django 5.2.7 on 2026-04-13 09:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title1_de", models.CharField(max_length=255, null=True)),
                ("title1_en", models.CharField(max_length=255, null=True)),
                ("title2", models.CharField(max_length=255)),
                ("title2_de", models.CharField(max_length=255, null=True)),
                ("title2_en", models.CharField(max_length=255, null=True)),
                ("title3", models.CharField(max_length=255)),
                ("title3_de", models.CharField(max_length=255, null=True)),
                ("title3_en", models.CharField(max_length=255, null=True)),
                ("title4", models.CharField(max_length=255)),
                ("title4_de", models.CharField(max_length=255, null=True)),
                ("title4_en", models.CharField(max_length=255, null=True)),
                ("sub_title1", models.CharField(max_length=255)),
                ("sub_title1_de", models.CharField(max_length=255, null=True)),
                ("sub_title1_en", models.CharField(max_length=255, null=True)),
                ("sub_title2", models.CharField(max_length=255)),
                ("sub_title2_de", models.CharField(max_length=255, null=True)),
                ("sub_title2_en", models.CharField(max_length=255, null=True)),
                ("email", models.EmailField(blank=True, max_length=254, null=True)),
            ],
            options={
                "constraints": [
                    models.UniqueConstraint(fields=("title2",), name="unique_sfield"),
                    models.UniqueConstraint(fields=("title3", "sub_title2"), name="unique_mfields"),
                    models.UniqueConstraint(fields=("title3", "email"), name="unique_partfield"),
                    modeltranslation.tests.models.CustomUniqueConstraint(
                        fields=("title4", "email"), name="unique_custom"
                    ),
                    models.UniqueConstraint(fields=("title2_de",), name="unique_sfield-de"),
                    models.UniqueConstraint(fields=("title2_en",), name="unique_sfield-en"),
                    models.UniqueConstraint(
                        fields=("title3_de", "sub_title2_de"), name="unique_mfields-de"
                    ),
                    models.UniqueConstraint(
                        fields=("title3_en", "sub_title2_en"), name="unique_mfields-en"
                    ),
                    models.UniqueConstraint(
                        fields=("title3_de", "email"), name="unique_partfield-de"
                    ),
                    models.UniqueConstraint(
                        fields=("title3_en", "email"), name="unique_partfield-en"
                    ),
                    modeltranslation.tests.models.CustomUniqueConstraint(
                        fields=("title4_de", "email"), name="unique_custom-de"
                    ),
                    modeltranslation.tests.models.CustomUniqueConstraint(
                        fields=("title4_en", "email"), name="unique_custom-en"
                    ),
                ],
                "unique_together": {
                    ("title1", "sub_title1"),
                    ("title1_de", "sub_title1_de"),
                    ("title1_en", "sub_title1_en"),
                },
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    ...
                    models.Index(fields=["sub_title"], name="tests_model_sub_tit_d7dbf8_idx"),
                    models.Index(fields=["email"], name="idx_email"),
                    modeltranslation.tests.models.CustomIndex(
                        fields=["title", "email"], name="idx_custom"
                    ),
                    models.Index(fields=["title_de"], name="idx_title-de"),
                    models.Index(fields=["title_en"], name="idx_title-en"),
                    models.Index(
                        fields=["title_de", "sub_title_de"],
                        name="idx_title_sub_title-de",
                    ),
                    models.Index(
                        fields=["title_en", "sub_title_en"],
                        name="idx_title_sub_title-en",
                    ),
                    models.Index(fields=["sub_title_de"], name="tests_model_sub_tit_6e7854_idx"),
                    models.Index(fields=["sub_title_en"], name="tests_model_sub_tit_a38305_idx"),
                    modeltranslation.tests.models.CustomIndex(
                        fields=["title_de", "email"], name="idx_custom-de"
                    ),
                    modeltranslation.tests.models.CustomIndex(
                        fields=["title_en", "email"], name="idx_custom-en"
                    ),
                ],
            },
        ),
